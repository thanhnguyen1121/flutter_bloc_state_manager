...
class _$HomeStateTearOff {
  ...
  HomeStateData call(List<UserModel> userModels) {
...
class _$HomeStateData implements HomeStateData {
  const _$HomeStateData(this.userModels);
  ...
  @override
  String toString() {
    return 'HomeState(userModels: $userModels)';
  }
...
abstract class HomeStateData implements HomeState {
  const factory HomeStateData(List<UserModel> userModels) = _$HomeStateData;
